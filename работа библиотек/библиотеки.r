...
"ArcGIS" - система карт с тонкой настройкой. 
"esri-loader" - обёртка над "ArcGIS". Более удобней загружает модули и делает это лениво.

"Chart.js" - всякие 2d графики
"@splidejs/splide"  - слайдер. Есть React версия
"rc-slider"  -  Всякие ползунки для React
/*-----------------------------------------------------------------------------------------------*/
/*------<{ Общие }>---------------------*/
