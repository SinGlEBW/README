  ...
  Доп.Инфа:
    ...
    2. С точки зрения React, эти классовые и функциональные компоненты эквивалентны. Классовы компоненты обычно используют для
       управления состоянием "методами жизненного цикла". Они нужны для управления ресурсами приложения. 
        ...
        componentDidCatch() - срабатывает если есть ошибка в дочернем элементе. Пример ниже.
...
/*###########----------<{ Обработка ошибок }>----------############ 
    Если возникнет ошибка в Card то в данном родителе отработает componentDidCatch.
    Так же все ошибки в дереве React поднимаются и в конце концов их можно поймать через событие window.onerror
*/
