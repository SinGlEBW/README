...
str.replace(regexp|substr, newSubStr|function(){});//что найти, на что заменить. Возвращает обратно строку. Не меняет старую строку
...
str.codePointAt(inx) //вернёт ASCII код символа по указанному индексу
String.fromCodePoint(code)// вернёт индекс символа найденному по ASCII коду
/*--------------------------------------------------------------------------------------------------------------------------------------------*/
...
arr.includes(item);//есть ли в массиве искомый item. <- bool
