...
4й. ЭТАП. Авторизация тестировщика для получения данных с instagram
...
-------------------------------------------------------------------------------------------------
5й. ЭТАП.
  Обменять код на токен. Отправить нужно POST запрос, так что браузер не подходит.
...
На всякий приложу здесь.
  ...
  Получение долгосрочного: Я получал его в личном кабинете но есть альтернатива
    1. нужно разрешение instagram_graph_user_profile которое указывали на 4м этапе  {scope=user_profile}
...
<<<{{{{ Обмен долгосрочного токена на новый }}}}>>>
...
Получим таком же объект как описал выше
